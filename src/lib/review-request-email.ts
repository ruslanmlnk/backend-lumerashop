...
export function buildReviewRequestEmail(order: ReviewRequestEmail) {
  ...
  const subject = 'Jak se vám líbí váš nákup z LUMERASHOP?'
  const text = [
    'Dobrý den,',
    'Chceme se pro vás stále zlepšovat.',
    'Budeme vděční za krátkou recenzi. Jak jste spokojeni s nákupem.', '',
...
<p style="font-size:15px;line-height:1.8;margin:0 0 16px">Dobrý den,<br>Chceme se pro vás stále zlepšovat.</p>
<p style="font-size:15px;line-height:1.8;margin:0 0 24px;color:#5f584e">Budeme vděční za krátkou recenzi. Jak jste spokojeni s nákupem.</p>
...
<p style="font-size:15px;line-height:1.8;margin:0 0 24px">Děkujeme za váš čas a důvěru!<br><span style="font-family:Georgia,'Times New Roman',serif;font-size:21px">tým LUMERASHOP</span></p></td></tr>
